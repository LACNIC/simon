...
$(document).ready(function () {
    ...
    oTest.fnTest(
        ...
        function () {
            return $('#example tbody td:eq(1)').html() == "iPod Touch / iPhone";
        }
    );
    ...
    oTest.fnTest(
        ...
        function () {
            return $('#example tbody td:eq(1)').html() == "Safari 3.0";
        }
    );
    ...
    oTest.fnTest(
        ...
        function () {
            return $('#example tbody td:eq(3)').html() == "1";
        }
    );
    ...
    oTest.fnTest(
        ...
        function () {
            return $('#example tbody td:eq(3)').html() == "1.9";
        }
    );
    ...
    oTest.fnTest(
        ...
        function () {
            return $('#example tbody td:eq(3)').html() == "125.5";
        }
    );
    ...
    oTest.fnTest(
        ...
        function () {
            return $('#example tbody tr:eq(7) td:eq(1)').html() == "Firefox 1.0";
        }
    );
