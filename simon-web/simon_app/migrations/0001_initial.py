# -*- coding: utf-8 -*-
# Generated by Django 1.11.29 on 2020-10-07 18:01
...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.AutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('person', models.CharField(default=b'(No especificado)', max_length=200, null=True)),
                ('comment', models.TextField(default=b'')),
                ('date', models.DateTimeField(default=datetime.datetime(2020, 10, 7, 15, 1, 42, 299888))),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('date', models.DateTimeField(default=datetime.datetime(2020, 10, 7, 15, 1, 42, 299412))),
            ],
        ),
        migrations.CreateModel(
            name='RipeAtlasProbe',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.AutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('token', models.CharField(default=b'', max_length=100, verbose_name=b'Token de RIPE Atlas')),
                ('comments', models.TextField(default=b'', null=True, verbose_name=b'Comentarios')),
                ('date_added', models.DateTimeField(default=datetime.datetime(2020, 10, 7, 15, 1, 42, 298591))),
                ('probe', models.ForeignKey(null=True, on_delete=django.db.models.deletion.CASCADE, to='simon_app.RipeAtlasProbe')),
            ],
        ),
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.AutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('token_list', models.TextField(default=b'', verbose_name=b'Lista de Tokens separadas por saltos de linea')),
                ('processed', models.BooleanField(default=False)),
                ('date_added', models.DateTimeField(default=datetime.datetime(2020, 10, 7, 15, 1, 42, 299051))),
            ],
        ),
        migrations.CreateModel(
            name='TestPoint',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('speedtesttestpoint_ptr', models.OneToOneField(auto_created=True, on_delete=django.db.models.deletion.CASCADE, parent_link=True, primary_key=True, serialize=False, to='simon_app.SpeedtestTestPoint')),
            ...
            bases=('simon_app.speedtesttestpoint',),
        ),
        migrations.CreateModel(
            name='RipeAtlasPingResult',
            fields=[
                ('ripeatlasresult_ptr', models.OneToOneField(auto_created=True, on_delete=django.db.models.deletion.CASCADE, parent_link=True, primary_key=True, serialize=False, to='simon_app.RipeAtlasResult')),
            ],
            options={
                'verbose_name': 'Resultado RIPE Atlas ICMP Ping',
                'verbose_name_plural': 'Resultados RIPE Atlas ICMP Ping',
            },
            bases=('simon_app.ripeatlasresult',),
        ),
        migrations.CreateModel(
