...
class ProbeApiFetchFromFTP(models.Model):
    ...
    active_connection = models.CharField(max_length=64, null=True)
    device_info = models.CharField(max_length=128, null=True)
    package_name = models.CharField(max_length=128, null=True)
...
class ProbeApiV3ResultMetaData(models.Model):
    ...
    error_msg = models.CharField(default='', null=True, max_length=512)
