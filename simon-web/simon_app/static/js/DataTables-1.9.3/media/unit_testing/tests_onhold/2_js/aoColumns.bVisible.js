...
$(document).ready(function () {
    ...
    oTest.fnTest(
        ...
        null,
        function () {
            return $('#example thead tr:eq(0) th').length == 4;
        }
    );
    ...
    oTest.fnTest(
        ...
        null,
        function () {
            return $('#example tfoot tr:eq(0) th').length == 4;
        }
    );
    ...
    oTest.fnTest(
        ...
        function () {
            return $('#example tbody tr:eq(0) td').length == 2;
        }
    );
    ...
    oTest.fnTest(
        ...
        null,
        function () {
            return $('#example thead tr:eq(0) th').length == 2;
        }
    );
    ...
    oTest.fnTest(
        ...
        null,
        function () {
            return $('#example tfoot tr:eq(0) th').length == 2;
        }
    );
