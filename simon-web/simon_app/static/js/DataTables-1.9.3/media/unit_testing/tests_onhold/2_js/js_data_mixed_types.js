...
$(document).ready(function () {
    ...
    oTest.fnTest(
        ...
        function () {
            return $('#example tbody td:eq(1)').html() == "";
        }
    );
    ...
    oTest.fnTest(
        ...
        function () {
            return $('#example tbody td:eq(1)').html() == "true";
        }
    );
    ...
    oTest.fnTest(
        ...
        function () {
            return $('#example tbody td:eq(1)').html() == "Firefox 2.0";
        }
    );
    ...
    oTest.fnTest(
        ...
        function () {
            return $('#example tbody tr:eq(0) td:eq(1)').html() == "";
        }
    );
    ...
    oTest.fnTest(
        ...
        function () {
            return $('#example tbody tr:eq(0) td:eq(1)').html() == "true";
        }
    );
    ...
    oTest.fnTest(
        ...
        function () {
            return $('#example tbody tr:eq(0) td:eq(3)').html() == "5";
        }
    );
