...
$(document).ready(function () {
    ...
    oTest.fnWaitTest(
        ...
        function () {
            return $('#example tbody tr:eq(0) td:eq(1)').html() == 'aaa';
        }
    );
    ...
    oTest.fnWaitTest(
        ...
        function () {
            return $('#example tbody tr:eq(0) td:eq(0)').html() == 'aaa1';
        }
    );
    ...
    oTest.fnWaitTest(
        ...
        function () {
            return $('#example tbody tr:eq(0) td:eq(2)').html() == 'zzz3';
        }
    );
    ...
    oTest.fnWaitTest(
        ...
        function () {
            return $('#example tbody tr:eq(0) td:eq(4)').html() == 'A';
        }
    );
