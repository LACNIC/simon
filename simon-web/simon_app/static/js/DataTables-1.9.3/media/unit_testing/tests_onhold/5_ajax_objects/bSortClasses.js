...
$(document).ready(function () {
    ...
    oTest.fnWaitTest(
        ...
        null,
        function () {
            return $('#example tbody tr:eq(7) td:eq(0)').hasClass('sorting_1');
        }
    );
    ...
    oTest.fnWaitTest(
        ...
        null,
        function () {
            return $('#example tbody tr:eq(0) td:eq(1)').hasClass('sorting_1') == false;
        }
    );
    ...
    oTest.fnWaitTest(
        ...
        null,
        function () {
            return $('#example tbody tr:eq(1) td:eq(4)').hasClass('sorting_1');
        }
    );
