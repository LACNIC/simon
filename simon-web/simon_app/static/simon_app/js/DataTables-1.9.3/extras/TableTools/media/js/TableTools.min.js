...
(function (e, m, f) {
    ...
    TableTools.prototype = {fnGetSelected: function () {
        ...
        c = 0;
        for (d = b.length; c < d; c++)b[c]._DTTT_selected && a.push(b[c].nTr);
        return a
    }, fnGetSelectedData: function () {
        var a = [], b = this.s.dt.aoData, c, d;
        c = 0;
        for (d = b.length; c < d; c++)b[c]._DTTT_selected &&
        a.push(this.s.dt.oInstance.fnGetData(c));
        return a
        ...
        var b = this._fnGetMasterSettings();
        this._fnRowDeselect(!0 === a ? b.dt.aiDisplay : b.dt.aoData)
    }, fnSelect: function (a) {
        "single" == this.s.select.type ? (this.fnSelectNone(), this._fnRowSelect(a)) : "multi" == this.s.select.type &&
            this._fnRowSelect(a)
    }, fnDeselect: function (a) {
        this._fnRowDeselect(a)
    }, fnGetTitle: function (a) {
        var b = "";
        "undefined" != typeof a.sTitle && "" !== a.sTitle ? b = a.sTitle : (a = f.getElementsByTagName("title"), 0 < a.length && (b = a[0].innerHTML));
        return 4 > "\u00a1".toString().length ? b.replace(/[^a-zA-Z0-9_\u00A1-\uFFFF\.,\-_ !\(\)]/g, "") : b.replace(/[^a-zA-Z0-9_\.,\-_ !\(\)]/g, "")
    }, fnCalcColRatios: function (a) {
        var b = this.s.dt.aoColumns, a = this._fnColumnTargets(a.mColumns), c = [], d = 0, e = 0, h, f;
        h = 0;
        for (f = a.length; h < f; h++)a[h] && (d =
            b[h].nTh.offsetWidth, e += d, c.push(d));
        h = 0;
        for (f = c.length; h < f; h++)c[h] /= e;
        return c.join("\t")
        ...
        for (var a in ZeroClipboard_TableTools.clients)if (a) {
            var b =
                ZeroClipboard_TableTools.clients[a];
        ...
        this.dom.container = f.createElement(this.s.tags.container);
        ...
        this.s.custom =
            e.extend({}, TableTools.DEFAULTS, a);
        ...
        var c, d, e;
        b ? (c = "default" !== a.sTag ? a.sTag : this.s.tags.collection.button, d = "default" !== a.sLinerTag ?
            a.sLiner : this.s.tags.collection.liner, e = this.classes.collection.buttons.normal) : (c = "default" !== a.sTag ? a.sTag : this.s.tags.button, d = "default" !== a.sLinerTag ? a.sLiner : this.s.tags.liner, e = this.classes.buttons.normal);
        c = f.createElement(c);
        d = f.createElement(d);
        var h = this._fnGetMasterSettings();
        c.className = e + " " + a.sButtonClass;
        c.setAttribute("id", "ToolTables_" + this.s.dt.sInstance + "_" + h.buttonCounter);
        c.appendChild(d);
        ...
        var c = f.createElement(this.s.tags.collection.container);
        ...
        var c = this, d = e(a).offset(), g = b._collection, h = d.left, d = d.top + e(a).outerHeight(), p = e(m).height(), j = e(f).height(), k = e(m).width(),
            n = e(f).width();
        ...
        p = e(g).outerWidth();
        k = e(g).outerHeight();
        h + p > n && (g.style.left = n - p + "px");
        d + k > j && (g.style.top = d - k - e(a).outerHeight() +
            "px");
        ...
        !(null !== b && "collection" == b.sExtends) && null !== this.dom.collection.collection && (e(this.dom.collection.collection).animate({opacity: 0}, 500, function () {
            this.style.display = "none"
        }), e(this.dom.collection.background).animate({opacity: 0},
            500, function () {
        ...
        if (this.s.master) {
            ...
            e("tr", b.nTBody).live("click", function (c) {
                if (this.parentNode == b.nTBody && null !== b.oInstance.fnGetData(this) && (null === a.s.select.preRowSelect || a.s.select.preRowSelect.call(a, c)))a.fnIsSelected(this) ? a._fnRowDeselect(this) : "single" == a.s.select.type ? (a.fnSelectNone(),
                    a._fnRowSelect(this)) : "multi" == a.s.select.type && a._fnRowSelect(this)
            });
            b.oApi._fnCallbackReg(b, "aoRowCreatedCallback", function (c, d, g) {
                b.aoData[g]._DTTT_selected && e(c).addClass(a.classes.select.row)
            }, "TableTools-SelectAll")
        }
    }, _fnRowSelect: function (a) {
        for (var a = this._fnSelectData(a), b = 0 === a.length ? null : a[0].nTr, c = 0, d = a.length; c < d; c++)a[c]._DTTT_selected = !0, a[c].nTr && e(a[c].nTr).addClass(this.classes.select.row);
        null !== this.s.select.postSelected && this.s.select.postSelected.call(this, b);
        TableTools._fnEventDispatch(this,
            "select", b)
    }, _fnRowDeselect: function (a) {
        for (var a = this._fnSelectData(a), b = 0 === a.length ? null : a[0].nTr, c = 0, d = a.length; c < d; c++)a[c].nTr && a[c]._DTTT_selected && e(a[c].nTr).removeClass(this.classes.select.row), a[c]._DTTT_selected = !1;
        null !== this.s.select.postDeselected && this.s.select.postDeselected.call(this, b);
        TableTools._fnEventDispatch(this, "select", b)
        ...
        null !== b.fnInit && b.fnInit.call(this, a, b);
        d.setHandCursor(!0);
        "flash_save" == b.sAction ? (d.setAction("save"), d.setCharSet("utf16le" == b.sCharSet ? "UTF16LE" : "UTF8"), d.setBomInc(b.bBomInc), d.setFileName(b.sFileName.replace("*", this.fnGetTitle(b)))) :
                "flash_pdf" == b.sAction ? (d.setAction("pdf"), d.setFileName(b.sFileName.replace("*", this.fnGetTitle(b)))) : d.setAction("copy");
        ...
        d.addEventListener("complete", function (e, h) {
        ...
        f.getElementById(e) ? a.glue(b, c) : setTimeout(function () {
        ...
        if ("object" == typeof a) {
            ...
            i = 0;
            for (iLen = c.aoColumns.length; i < iLen; i++)b.push(!0)
        }
        return b
        ...
        var b,
            c, d, g, h, f = [], j = "", k = this.s.dt, n, l = RegExp(a.sFieldBoundary, "g"), m = this._fnColumnTargets(a.mColumns);
        d = "undefined" != typeof a.bSelectedOnly ? a.bSelectedOnly : !1;
        if (a.bHeader) {
            h = [];
            b = 0;
            for (c = k.aoColumns.length; b < c; b++)m[b] && (j = k.aoColumns[b].sTitle.replace(/\n/g, " ").replace(/<.*?>/g, "").replace(/^\s+|\s+$/g, ""), j = this._fnHtmlDecode(j), h.push(this._fnBoundData(j, a.sFieldBoundary, l)));
            f.push(h.join(a.sFieldSeperator))
        }
        var o = k.aiDisplay;
        g = this.fnGetSelected();
        if ("none" !== this.s.select.type && d && 0 !== g.length) {
            o =
                [];
            b = 0;
            for (c = g.length; b < c; b++)o.push(k.oInstance.fnGetPosition(g[b]))
        }
        d = 0;
        for (g = o.length; d < g; d++) {
            n = k.aoData[o[d]].nTr;
            h = [];
            b = 0;
            for (c = k.aoColumns.length; b < c; b++)m[b] && (j = k.oApi._fnGetCellData(k, o[d], b, "display"), a.fnCellRender ? j = a.fnCellRender(j, b, n, o[d]) + "" : "string" == typeof j ? (j = j.replace(/\n/g, " "), j = j.replace(/<img.*?\s+alt\s*=\s*(?:"([^"]+)"|'([^']+)'|([^\s>]+)).*?>/gi, "$1$2$3"), j = j.replace(/<.*?>/g, "")) : j += "", j = j.replace(/^\s+/, "").replace(/\s+$/, ""), j = this._fnHtmlDecode(j), h.push(this._fnBoundData(j,
                a.sFieldBoundary, l)));
            f.push(h.join(a.sFieldSeperator));
            a.bOpenRows && (b = e.grep(k.aoOpenRows, function (a) {
                return a.nParent === n
            }), 1 === b.length && (j = this._fnBoundData(e("td", b[0].nTr).html(), a.sFieldBoundary, l), f.push(j)))
        }
        if (a.bFooter && null !== k.nTFoot) {
            h = [];
            b = 0;
            for (c = k.aoColumns.length; b < c; b++)m[b] && null !== k.aoColumns[b].nTf && (j = k.aoColumns[b].nTf.innerHTML.replace(/\n/g, " ").replace(/<.*?>/g, ""), j = this._fnHtmlDecode(j), h.push(this._fnBoundData(j, a.sFieldBoundary, l)));
            f.push(h.join(a.sFieldSeperator))
        }
        return _sLastData =
            f.join(this._fnNewline(a))
        ...
        var a = this._fnChunkData(a, 2048), b = f.createElement("div"), c, d, e, h = "";
        c = 0;
        for (d = a.length; c < d; c++)e = a[c].lastIndexOf("&"), -1 != e && (8 <= a[c].length && e > a[c].length - 8) && (a[c].substr(e), a[c] = a[c].substr(0, e)), b.innerHTML = a[c], h +=
        ...
        ("" !== c.oScroll.sX || "" !== c.oScroll.sY) && this._fnPrintScrollStart(c);
        var c = c.aanFeatures, d;
        for (d in c)if ("i" != d && "t" != d && 1 == d.length)for (var g = 0, h = c[d].length; g < h; g++)this.dom.print.hidden.push({node: c[d][g],
            display: "block"}), c[d][g].style.display = "none";
        e(f.body).addClass(this.classes.print.body);
        "" !== a.sInfo && this.fnInfo(a.sInfo, 3E3);
        a.sMessage && (this.dom.print.message = f.createElement("div"), this.dom.print.message.className = this.classes.print.message, this.dom.print.message.innerHTML = a.sMessage, f.body.insertBefore(this.dom.print.message, f.body.childNodes[0]));
        this.s.print.saveScroll = e(m).scrollTop();
        m.scrollTo(0, 0);
        e(f).bind("keydown.DTTT", function (a) {
            if (a.keyCode == 27) {
                a.preventDefault();
                b._fnPrintEnd.call(b,
                    a)
            }
        })
        ...
        "" !== a.oScroll.sX && (a.nTable.style.width = e(a.nTable).outerWidth() + "px", b.style.width = e(a.nTable).outerWidth() + "px", b.style.overflow =
            "visible");
        ...
        _fnPrintHideNodes: function (a) {
            for (var b = this.dom.print.hidden, c = a.parentNode, d = c.childNodes, g = 0, h = d.length; g < h; g++)if (d[g] != a && 1 == d[g].nodeType) {
                var f = e(d[g]).css("display");
                "none" != f && (b.push({node: d[g], display: f}), d[g].style.display = "none")
            }
    ...
    TableTools._fnEventDispatch = function (a, b, c) {
        for (var d = TableTools._aListeners, e = 0, f = d.length; e < f; e++)a.dom.table == d[e].that.dom.table && d[e].type ==
            b && d[e].fn(c)
    };
    ...
    TableTools.BUTTONS = {csv: e.extend({}, TableTools.buttonBase, {sAction: "flash_save",
        sButtonClass: "DTTT_button_csv", sButtonText: "CSV", sFieldBoundary: '"', sFieldSeperator: ",", fnClick: function (a, b, c) {
    ...
    }}), print: e.extend({}, TableTools.buttonBase, {sInfo: "<h6>Print view</h6><p>Please use your browser's print function to print this table. Press escape when finished.", sMessage: null, bShowAll: !0, sToolTip: "View print view", sButtonClass: "DTTT_button_print", sButtonText: "Print", fnClick: function (a, b) {
        this.fnPrint(!0, b)
    }}), text: e.extend({}, TableTools.buttonBase), select: e.extend({},
        TableTools.buttonBase, {sButtonText: "Select button", fnSelect: function (a) {
        ...
        select_all: e.extend({}, TableTools.buttonBase, {sButtonText: "Select all", fnClick: function () {
            ...
            alert("Ajax complete")
        }}), div: e.extend({}, TableTools.buttonBase, {sAction: "div",
            sTag: "div", sButtonClass: "DTTT_nonbutton", sButtonText: "Text button"}), collection: e.extend({}, TableTools.buttonBase, {sAction: "collection", sButtonClass: "DTTT_button_collection", sButtonText: "Collection", fnClick: function (a, b) {
            this._fnCollectionShow(a, b)
        }})};
    TableTools.classes = {container: "DTTT_container", buttons: {normal: "DTTT_button", disabled: "DTTT_disabled"}, collection: {container: "DTTT_collection", background: "DTTT_collection_background", buttons: {normal: "DTTT_button", disabled: "DTTT_disabled"}}, select: {table: "DTTT_selectable",
    ...
    TableTools.DEFAULTS = {sSwfPath: "media/swf/copy_csv_xls_pdf.swf", sRowSelect: "none", sSelectedClass: null, fnPreRowSelect: null, fnRowSelected: null, fnRowDeselected: null, aButtons: ["copy", "csv",
        "xls", "pdf", "print"], oTags: {container: "div", button: "a", liner: "span", collection: {container: "div", button: "a", liner: "span"}}};
    TableTools.prototype.CLASS = "TableTools";
    TableTools.VERSION = "2.1.3";
    TableTools.prototype.VERSION = TableTools.VERSION;
    "function" == typeof e.fn.dataTable && "function" == typeof e.fn.dataTableExt.fnVersionCheck && e.fn.dataTableExt.fnVersionCheck("1.9.0") ? e.fn.dataTableExt.aoFeatures.push({fnInit: function (a) {
