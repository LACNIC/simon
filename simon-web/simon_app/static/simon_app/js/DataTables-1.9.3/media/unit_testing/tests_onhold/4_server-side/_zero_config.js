...
oTest.fnWaitTest(
    ...
    null,
    function () {
        return typeof jQuery().dataTable == "function";
    }
);
...
oTest.fnWaitTest(
    ...
    null,
    function () {
        return typeof jQuery().dataTableSettings == "object";
    }
);
...
oTest.fnWaitTest(
    ...
    null,
    function () {
        return typeof jQuery().dataTableExt == "object";
    }
);
...
$(document).ready(function () {
    ...
    oTest.fnWaitTest(
        ...
        null,
        function () {
            return document.getElementById('example_processing') == null;
        }
    );
    ...
    oTest.fnWaitTest(
        ...
        function () {
            return $('#example tbody td:eq(3)').html() == "-";
        }
    );
    ...
    oTest.fnWaitTest(
        ...
        function () {
            return $('#example tbody td:eq(3)').html() == "522.1";
        }
    );
    ...
    oTest.fnWaitTest(
        ...
        function () {
            var b =
                $('#example tbody td:eq(0)').html() == "Gecko" &&
                $('#example tbody td:eq(1)').html() == "Firefox 1.0";
            return b;
        }
    );
    ...
    oTest.fnWaitTest(
        ...
        function () {
            return $('#example tbody td:eq(1)').html() == "Mozilla 1.1";
        }
    );
    ...
    oTest.fnWaitTest(
        ...
        function () {
            return $('#example tbody tr').length == 50;
        }
    );
    ...
    oTest.fnWaitTest(
        ...
        function () {
            return document.getElementById('example_info').innerHTML == "Showing 11 to 20 of 57 entries";
        }
    );
    ...
    oTest.fnWaitTest(
        ...
        function () {
            return document.getElementById('example_info').innerHTML == "Showing 21 to 30 of 57 entries";
        }
    );
    ...
    oTest.fnWaitTest(
        ...
        function () {
            return document.getElementById('example_info').innerHTML == "Showing 1 to 25 of 57 entries";
        }
    );
    ...
    oTest.fnWaitTest(
        ...
        function () {
            return document.getElementById('example_info').innerHTML == "Showing 26 to 50 of 57 entries";
        }
    );
    ...
    oTest.fnWaitTest(
        ...
        function () {
            $('#example_filter input').val("Win 98").keyup();
        },
        function () {
            return document.getElementById('example_info').innerHTML ==
    ...
    oTest.fnWaitTest(
        ...
        function () {
            return $('#example tbody tr:eq(4) td:eq(1)').html() == "Netscape 7.2";
        }
    );
    ...
    oTest.fnWaitTest(
        ...
        function () {
            return $('#example tbody tr:eq(0) td:eq(1)').html() == "AOL browser (AOL desktop)";
        }
    );
    ...
    oTest.fnWaitTest(
        ...
        function () {
            return $('#example tbody tr:eq(0) td:eq(1)').html() == "Seamonkey 1.1";
        }
    );
    ...
    oTest.fnWaitTest(
        ...
        function () {
            $('#example_filter input').val("Win XP").keyup();
        },
        function () {
            return $('#example tbody tr:eq(0) td:eq(1)').html() == "Internet Explorer 7";
        }
    );
    ...
    oTest.fnWaitTest(
        ...
        function () {
            return $('#example tbody tr:eq(0) td:eq(3)').html() == "6";
        }
    );
    ...
    oTest.fnWaitTest(
        ...
        function () {
            return $('#example tbody tr:eq(0) td:eq(3)').html() == "7";
        }
    );
    ...
    oTest.fnWaitTest(
        "Filter 'nothinghere'",
        function () {
            $('#example_filter input').val("nothinghere").keyup();
        },
        function () {
