...
$(document).ready(function () {
    ...
    oTest.fnWaitTest(
        ...
        function () {
            return $('#example tbody tr').length == 20;
        }
    );
    ...
    oTest.fnTest(
        ...
        null,
        function () {
            return $('#example_info').html() == "Showing 1 to 20 of 57 entries";
        }
    );
    ...
    oTest.fnTest(
        ...
        null,
        function () {
            return $('#example').dataTable().fnGetNodes().length == 20;
        }
    );
    ...
    oTest.fnWaitTest(
        ...
        function () {
            $('div.dataTables_scrollBody').scrollTop(30);
        },
        function () {
            return $('#example tbody tr').length == 20;
        }
    ...
    oTest.fnWaitTest(
        ...
        function () {
            $('div.dataTables_scrollBody').scrollTop(280);
        },
        function () {
            return $('#example tbody tr').length == 30;
        }
    );
    ...
    oTest.fnTest(
        ...
        null,
        function () {
            return $('#example_info').html() == "Showing 1 to 30 of 57 entries";
        }
    );
    ...
    oTest.fnTest(
        ...
        null,
        function () {
            return $('#example').dataTable().fnGetNodes().length == 30;
        }
    );
    ...
    oTest.fnTest(
        ...
        null,
        function () {
            return $('#example_info').html() == "Showing 1 to 10 of 20 entries (filtered from 57 total entries)";
        }
    );
