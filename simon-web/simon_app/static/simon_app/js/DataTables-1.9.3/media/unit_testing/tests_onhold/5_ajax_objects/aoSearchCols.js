...
$(document).ready(function () {
    ...
    oTest.fnWaitTest(
        ...
        function () {
            return $('#example_info').html() == "Showing 1 to 9 of 9 entries (filtered from 57 total entries)";
        }
    );
    ...
    oTest.fnWaitTest(
        ...
        function () {
            return $('#example tbody tr:eq(0) td:eq(3)').html() == "1.5";
        }
    );
    ...
    oTest.fnWaitTest(
        ...
        function () {
            return $('#example_info').html() == "Showing 1 to 3 of 3 entries (filtered from 57 total entries)";
        }
    );
    ...
    oTest.fnWaitTest(
        ...
        function () {
            return $('#example tbody tr:eq(0) td:eq(1)').html() == "Konqureror 3.3";
        }
    );
