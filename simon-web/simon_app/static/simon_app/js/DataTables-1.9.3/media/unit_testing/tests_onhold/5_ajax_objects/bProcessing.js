...
$(document).ready(function () {
    ...
    oTest.fnWaitTest(
        ...
        null,
        function () {
            return oSettings.oFeatures.bProcessing == false;
        }
    );
    ...
    oTest.fnWaitTest(
        ...
        function () {
            return oSettings.oFeatures.bProcessing == true;
        }
    );
    ...
    oTest.fnWaitTest(
        ...
        function () {
            return document.getElementById('example_processing');
        }
    );
    ...
    oTest.fnWaitTest(
        ...
        function () {
            return document.getElementById('example_processing').style.visibility = "hidden";
        }
    );
    ...
    oTest.fnWaitTest(
        ...
        function () {
            return document.getElementById('example_processing').style.visibility = "visible";
        }
    );
