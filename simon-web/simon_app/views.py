        ...
        try:
            ...
            for answer in answers:
                ...
                if IN_LACNIC_RESOURCES is not True or MEETS_BANDWITH is not True or HAS_IP is not True:  # triple condition not to repeat all the mailing text....
                    ...
                    texto = 'Este mensaje ha sido enviado a la lista de correo del Proyecto Simón. El punto %s en %s quiere formar parte de la lista de servidores WEB, pero %s. Para darle de alta por favor póngase en contacto con %s. Muchas gracias.' % (str(testPoint.ip_address), str(country_printable), problema, str(volunteer_email))
                ...
                texto = 'Este mensaje ha sido enviado a la lista de correo del Proyecto Simón. El punto %s ubicado en %s ha sido agregado a la lista de puntos web de testeo. Para darle de alta por favor hágalo mediante el administrados de Django. Muchas gracias.' % (str(testPoint.ip_address), str(testPoint.country))
